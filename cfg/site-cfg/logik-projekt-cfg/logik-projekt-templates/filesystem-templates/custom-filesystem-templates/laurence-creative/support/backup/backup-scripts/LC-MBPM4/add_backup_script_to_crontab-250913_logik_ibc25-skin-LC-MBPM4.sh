...
# Define paths
backup_script_path="/PROJEKTS/250913_logik_ibc25-skin//backup/backup-scripts/LC-MBPM4/backup-250913_logik_ibc25-skin-LC-MBPM4.sh"
backup_script_cron_log_dir="/PROJEKTS/250913_logik_ibc25-skin//backup/backup-scripts/LC-MBPM4/cron_log"
