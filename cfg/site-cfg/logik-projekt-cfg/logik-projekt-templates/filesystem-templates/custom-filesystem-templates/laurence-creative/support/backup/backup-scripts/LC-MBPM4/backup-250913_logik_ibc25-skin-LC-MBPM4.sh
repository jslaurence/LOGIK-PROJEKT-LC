...
# Backup Script Name:   backup-250913_logik_ibc25-skin-LC-MBPM4.sh
# Backup Script for:    250913_logik_ibc25-skin
...
the_projekt_job_rsync_directory="${the_projekt_job_directory}/backup/backup-scripts/LC-MBPM4"
...
the_projekt_job_rsync_exclusion_list="${the_projekt_job_rsync_directory}/backup-250913_logik_ibc25-skin-LC-MBPM4-exclusion_list.txt"
...
backup_prefs_file="${path_to_here}/backup_prefs_LC-MBPM4"
